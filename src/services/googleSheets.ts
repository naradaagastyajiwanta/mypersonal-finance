...
export class GoogleSheetsService {
  ...
  clearSpreadsheetData(): void {
    ...
    console.log('Cleared spreadsheet data');
  }
  ...
  async getTransactions(): Promise<Transaction[]> {
    try {
      const spreadsheetId = await this.ensureSpreadsheetExists();
